...
const Home = () => {
    ...
    return (
        <div className='h-auto ml-auto mr-auto lg:w-[1440px]'>
            <Intro />
            ...
            <div className="pt-[80px] ml-auto mr-auto bg-linear-bw md:bg-linear-bw-md lg:w-[1440px] lg: md:bg-linear-bw-md">
                <CallToAction />
            </div>
            <div className='pl-6 pr-6 bg-[#1D1C1E] lg:w-[1440px] lg:pl-0 lg:pr-0'>
                <Footer />
            </div>
        </div>
    )
